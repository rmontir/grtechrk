(function ($) {
    ...
    function OrgChart($container, opts) {
        ...
        this.draw = function () {
            ...
            if (opts.allowEdit) {
                $container.find('.node span').click(function (e) {
        ...
        this.startEdit = function (id) {
            ...
            $container.find('div[node-id=' + id + '] span').replaceWith(inputElement);
            var commitChange = function () {
                var spanElement = $('<span>' + nodes[id].data.name + '</span>');
                if (opts.allowEdit) {
    ...
    function Node(data) {
        ...
        this.formatNode = function (opts) {
            ...
            if (typeof data.position !== 'undefined') {
                positionString = '<span>' + self.data.position + '</span>';
            }
            if (typeof data.email !== 'undefined') {
                emailString = '<span>' + self.data.email + '</span>';
            }
            ...
            //return "<div class='node' node-id='" + this.data.id + "'>" + nameString + "<div class='row no-margin'>" + positionString + emailString + "</div>" + descString + buttonsHtml + "</div>";
            return "<div class='node' node-id='" + this.data.id + "'><div class='card card-info'><div class='card-header'>" + positionString + "</div><div class='card-body'>" + nameString + "</div><div class='card-footer'>" + emailString + "</div></div></div>";
        }
    }
